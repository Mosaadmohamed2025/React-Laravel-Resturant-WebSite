...
const Footer = () => {
  return (
    <footer  data-aos="fade-up" className="shadow-md   bg-white dark:bg-[#0e100f]">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="" className="flex items-center">
                  <img src={logo2}className="h-14 w-14 mr-3" alt="FlowBite Logo" />
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-[#777] text-[#212245] dark:text-[#ff9800]">Italiano</span>
                  
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h3 className="mb-6 text-sm font-semibold text-[#212245] uppercase dark:text-[#ff9800]">Delivery Time</h3>
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      ...
                      <li>
                      <span className='font-bold'>Friday - Saturday</span><br />
                      Off day</li>
                  </ul>
              </div>
              <div>
                  <h3 className="mb-6 text-sm font-semibold text-[#212245] uppercase dark:text-[#ff9800]">Follow us</h3>
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
              ...
              <div>
                  <h3 className="mb-6 text-sm font-semibold text-[#212245] uppercase dark:text-[#ff9800]">Legal</h3>
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="" className="hover:underline">Italiano</a>. All Rights Reserved.
          </span>
